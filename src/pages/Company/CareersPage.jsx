    ...
    <div className="min-h-screen bg-base-200 py-16">
      <div className="site-shell flex items-center justify-center">
        <div className="w-full max-w-3xl text-center">
          <h1 className="mb-4 text-4xl font-bold">Careers at Smart Shop</h1>
          ...
          <div className="mt-10">
            ...
            <p className="mt-2 opacity-70">We are hiring for the following roles:</p>

            <div className="mt-6 space-y-4">
              <div className="rounded-lg bg-base-100 p-5 shadow">
