    ...
    <div className="auth-shell min-h-[calc(100vh-64px)]">
      ...
      <div className="site-shell py-6 md:py-10 lg:py-14">
        <div className="mx-auto w-full max-w-[560px] lg:max-w-[1180px]">
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_540px] lg:gap-10">
            <div className="hidden lg:flex lg:min-h-full">
              <div className="auth-panel auth-panel-dark w-full rounded-[32px] border border-gray-200 p-10 shadow-sm">
                ...
                <p className="mt-4 max-w-xl text-base leading-7 text-gray-300">
                  Sign in to manage your account, review orders, save details, and continue
                  checkout smoothly across your devices.
                </p>

                <div className="mt-10 space-y-4">
                  <div className="rounded-[24px] border border-white/10 bg-white/5 p-5">
                    <div className="text-sm font-semibold text-white">Protected sign-in</div>
                    <div className="mt-2 text-sm leading-6 text-gray-300">
                      Secure authentication flow built for a clean and reliable customer
                      experience.
                    </div>
                  </div>

                  <div className="rounded-[24px] border border-white/10 bg-white/5 p-5">
                    <div className="text-sm font-semibold text-white">Faster shopping flow</div>
                    <div className="mt-2 text-sm leading-6 text-gray-300">
                      Keep your account ready for saved details, order tracking, and quicker
                      checkout.
                    </div>
                  </div>
              ...
              <form onSubmit={onSubmit} className={isBusy ? "pointer-events-none opacity-90" : ""}>
                <div className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={isBusy}
                    className="inline-flex min-h-[54px] w-full items-center justify-center gap-2 rounded-[20px] bg-black px-6 py-4 text-sm font-semibold text-white transition hover:bg-gray-900 disabled:cursor-not-allowed disabled:opacity-70 md:rounded-[22px]"
                  >
                    {emailLoading ? (
                      <>
                        <Loader2 className="animate-spin" size={18} />
